...
def main():
    global counter
    st.set_page_config(
    page_title="Quick Recipe Genie",  
    page_icon="🍴",  
    layout="centered"  
    )
    st.title("Recipe Genie using NLP")
    ...
    # Home Menu
    if choice == "Home":
        st.write("Welcome to Recipe Genie! Type a dish or ingredient, and let me suggest a recipe for you.")
